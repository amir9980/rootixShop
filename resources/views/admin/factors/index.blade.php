...
@section('page title','مدیریت خریدها')
...
@section('content')
    ...
    <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <select class="form-control" name="status">
                                        ...
                                        <option value="paid" @if(request()->query('status')=='paid') selected @endif>
                                            پرداخت شده
                                        </option>
                                        <option value="not_paid"
                                                @if(request()->query('status')=='not_paid') selected @endif>پرداحت نشده
                                        </option>
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">خرید های انجام شده</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <div id="example2_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example2"
                                   class="text-center table table-bordered table-striped table-hover dataTable"
                                   role="grid">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label=" وضعیت پرداخت: activate to sort column ascending">وضعیت پرداخت
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label=" وضعیت سفارش: activate to sort column ascending">وضعیت سفارش
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        ...
                                        <tr role="row" class="even">
                                            ...
                                            <td class="d-flex justify-content-around">
                                                <a href="{{route('factor.show',$factor->id)}}"
                                                   class="btn btn-sm btn-info"><i class="fa fa-list-ul d-block"
                                ...
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">وضعیت پرداخت</th>
